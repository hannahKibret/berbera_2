...
class _MaleClothingState extends State<MaleClothing> {
  ...
  void _validateImageUpload() async{
    if(_image != null){
      ...
      task1.onComplete.then((snapshot1) async{
        ...
        Map<String,dynamic> productDate={'Type':this._Male,'category':this._currentCategorySelected,'subcategory':this._currentSubSelected[index],'itemName':this._itemName,'brandName':this._currentBrandSelected,'size':this._sizes,'price':this._price,'amount':this._amount,'image':imageUrl};
